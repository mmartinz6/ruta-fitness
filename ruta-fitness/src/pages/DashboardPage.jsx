...
const DashboardPage = () => {
    // Se eliminaron 'navigate' y 'onLogout' ya que se manejan en el componente padre (MainLayout)

    return (
        // SOLUCIÓN: Solo devolvemos el contenido, el Layout (Sidebar) lo añade el router.
